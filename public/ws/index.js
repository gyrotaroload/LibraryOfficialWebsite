...
let ws = new WebSocket(`ws://${window.location.hostname}:${(document.getElementById('wsport')&&document.getElementById('wsport').innerText)?document.getElementById('wsport').innerText:'13030'}`);
var pdf_b64 = "";
function downpdf() {
    solution1(pdf_b64);
}
