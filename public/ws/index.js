...
let ws = new WebSocket(`${(document.getElementById('wsport')&&document.getElementById('wsport').innerText)?'wss':'ws'}w//${window.location.hostname}:${(document.getElementById('wsport')&&document.getElementById('wsport').innerText)?document.getElementById('wsport').innerText:'13030'}`);
var pdf_b64 = "";
function downpdf() {
    solution1(pdf_b64);
}
