const retext = require("fix-esm").require("retext");
const retextPos = require("fix-esm").require("retext-pos");
const retextKeywords = require("fix-esm").require("retext-keywords");
const toString = require("fix-esm").require("nlcst-to-string");
